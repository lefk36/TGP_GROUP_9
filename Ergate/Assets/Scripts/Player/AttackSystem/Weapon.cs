...
public class Weapon : MonoBehaviour
{
    ...
    {
        if (data.toEnemy && controllerScript.lockScript.m_LockOn && lockScript.m_TargetableEnemyIndex >= 0 && lockScript.m_TargetableEnemies[lockScript.m_TargetableEnemyIndex] != null)
        {
